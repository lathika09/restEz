...
class _UserPageState extends State<UserPage> {
  ...
  locateUserPosition() async{
    LocationPermission permission = await Geolocator.requestPermission();//check
    setState(() {
      _locationPermission = permission;
    });
            ...
            IconButton(
                onPressed: ()async {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RestroomPageUser(document: restroomDoc,dist:distance.toStringAsFixed(1), pos: cPosition, restroomloc: latLng,name: widget.name,id: 'ztQP5fpjvZtUNGiduAAz')));
